        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewedByAdminId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SectionTotalDurationMinutes = table.Column<int>(type: "int", nullable: true),
                    CourseId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnrollmentPriceAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    EnrollmentPriceCurrency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayoutCurrency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                    PayoutAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderTotalCurrency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                    OrderTaxAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    OrderTaxCurrency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentQuizAttempt_Users_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentTaxAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    PaymentTaxCurrency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: true),
                    ProviderChargeId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentItems_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryCourses_CategoryId_CourseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_CourseId_StudentId_InstructorId",
                table: "Conversations",
                columns: new[] { "CourseId", "StudentId", "InstructorId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CouponUsages_CouponId_UserId_UsedAtUtc",
                table: "CouponUsages",
                columns: new[] { "CouponId", "UserId", "UsedAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseApprovalHistories_CourseId_ReviewedAtUtc",
                table: "CourseApprovalHistories",
                columns: new[] { "CourseId", "ReviewedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_CourseProgress_CourseId_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentQuizAttempt_AppUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WishListCourses_WishListId_CourseId",
                table: "WishListCourses",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Certificates_Media_MediaId",
                table: "Certificates",
                column: "MediaId",
                principalTable: "Media",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Courses_Media_ThumbnailId",
                table: "Courses",
                column: "ThumbnailId",
                principalTable: "Media",
                principalColumn: "Id",
