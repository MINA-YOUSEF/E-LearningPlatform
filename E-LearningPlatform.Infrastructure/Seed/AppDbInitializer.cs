...
namespace E_LearningPlatform.Infrastructure.Seed;
...
public static class AppDbInitializer
{
    public static async Task SeedAsync(IServiceProvider serviceProvider)
    {
        ...
        var roles = new[] { RoleNames.Admin, RoleNames.Instructor, RoleNames.Student };
        ...
        var adminEmail = configuration["Seed:AdminEmail"] ?? "admin@ELearning.local";
